...
app_no_ifw = client.get_IFW(application_number="14412875")
...
pat_no_ifw = client.get_IFW(patent_number="10765880")
...
pct_app_no_ifw = client.get_IFW(PCT_app_number="PCTUS0812705")
